...
<div class="container">
    ...
    <div class="row align-items-center mx-2 ">
        <span class="badge rounded-pill text-bg-primary">CIC: {{$conteo->CIC}}</span>
    </div>
    <div class="row align-items-center mx-2 ">
        <span class="badge rounded-pill text-bg-primary">CSI: {{$conteo->CSI}}</span>
    </div>
    <div class="row align-items-center mx-2 ">
        <span class="badge rounded-pill text-bg-info">HCM: {{$conteo->HCM}}</span>
    </div>
    <div class="row align-items-center mx-2 ">
        <span class="badge rounded-pill text-bg-info">CeCom: {{$conteo->CeCom}}</span>
    </div>
    <div class="row align-items-center mx-2 ">
        <span class="badge rounded-pill text-bg-info">PROV: {{$conteo->PROV}}</span>
    </div>
    <div class="row align-items-center mx-2 ">
        <span class="badge rounded-pill text-bg-info">COR: {{$conteo->COR}}</span>
    </div>

    <div class="row align-items-center mx-2 ">
        <span class="badge rounded-pill text-bg-success">Total: {{$conteo->TotalCallcenter}}</span>
    </div>
